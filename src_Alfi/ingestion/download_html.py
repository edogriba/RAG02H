...
def download_html_from_url(url: str, save_dir: str, filename: str = "downloaded_page.html") -> None:
    """
    ...
    if response.status_code == 200:
        ...
        logger.error(f"Failed to download the webpage. Status code: {response.status_code}")
